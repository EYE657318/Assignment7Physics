...
#include <vector>
#include <memory>
#include "GLViewAAATestingPhysics.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAAATestingPhysics > glView( Aftr::GLViewAAATestingPhysics::New( args ) );
